...
function todosIguales(array) {
   ...
   for (let i = 1; i < array.length; i++) {
       if (array[i] !== primerElemento) {
           return false; // Si se encuentra un elemento diferente, no son todos iguales.
       }
   }
...
function mesesDelAño(array) {
   ...
   // Tu código:
   const mesesPedidos = ["Marzo", "Noviembre", "Enero"];
   const mesesEncontrados = mesesPedidos.filter(mes => array.includes(mes));
